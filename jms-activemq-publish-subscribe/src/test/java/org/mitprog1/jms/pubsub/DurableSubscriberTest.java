...
public class DurableSubscriberTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        subscriberPublishSubscribe.create("subscriber-publishsubscribe", "publishsubscribe.t", "publishsubscribe");
    ...
    public void testDurableSubscriber() {
        try {
            // durable subscriptions, receive messages sent while the subscribers are not active
            subscriber2DurableSubscriber.closeConnection();
