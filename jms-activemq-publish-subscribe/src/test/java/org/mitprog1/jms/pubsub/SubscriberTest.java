...
//------------------------------------
    ...
    public void testNonDurableSubscriber() {
        try {
            // non-durable subscriptions, will not receive messages sent while the subscribers are not active
            subscriber2NonDurableSubscriber.closeConnection();
            ...
            String greeting1 = subscriber1NonDurableSubscriber.getGreeting(1000);
            assertEquals("Hello Bilbo Baggins!", greeting1);
            String greeting2 = subscriber1NonDurableSubscriber.getGreeting(1000);
            assertEquals("Hello Frodo Baggins!", greeting2);

            String greeting3 = subscriber2NonDurableSubscriber.getGreeting(1000);
            assertEquals("Hello Frodo Baggins!", greeting3);
            String greeting4 = subscriber2NonDurableSubscriber.getGreeting(1000);
